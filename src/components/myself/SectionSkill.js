...
function SectionSkill() {
  ...
  const skills = [
    ...
    { img: sass, percent: "90" },
    { img: figma, percent: "90" },
    { img: react, percent: "90" },
    { img: vscode, percent: "90" },
    { img: spring, percent: "85" },
    { img: eclipce, percent: "85" },
    { img: java, percent: "80" },
    { img: node, percent: "75" },
    { img: mongodb, percent: "70" },
    { img: oracle, percent: "70" },
    { img: dbeaver, percent: "70" },
    { img: postgresql, percent: "70" },
    { img: qgis, percent: "70" },
